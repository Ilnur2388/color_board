...
const CANVAS_HEIGHT = 300;
  ...
  function extractCordinates(canvas, event) { //функ-ия извлекает координаты с холста
   let rect = canvas.getBoudingClientRect();
...
export default class extends Controller {
  ...
  mouseMove(event) {
    let { x, y } = extractCordinates(this.canvasTarget, event);
